> ⚠️ **Warning: This project is outdated and no longer supported.** 🚫
>
> ⛔ Do not use this Docker/web workflow. For HDR export, use the [Lightroom plugin](https://github.com/karachungen/lightroom-plugin-export-hdr) instead — it exports Ultra HDR JPEG directly from Lightroom Classic (no Docker or web conversion step).

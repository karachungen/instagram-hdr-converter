...
const selectedMethod = ref<'avif' | 'jpg'>('avif')
</script>
...
<template>
  <UCard v-if="filesStore.files.length > 0" class="file-list-section">
    <div class="space-y-4 mb-4">
      <div class="flex items-center justify-between">
        ...
        <UButton label="Clear All" icon="i-lucide-trash-2" color="gray" variant="outline" size="xs"
  ...
  <UCard class="mt-4">
    ...
    <div class="space-y-4">
      ...
      <UAccordion :items="exportMethods" v-model="selectedMethod" type="single" :ui="{
          body: 'text-sm'
        }">
        ...
        <template #method2>
          <div class="space-y-4">
            <UAlert color="warning" variant="subtle" icon="i-lucide-alert-triangle" title="Better SDR compatibility"
        ...
        <template #method1>
          <div class="space-y-4">
            <UAlert color="primary" variant="subtle" icon="i-lucide-star" title="Best for HDR accuracy"
